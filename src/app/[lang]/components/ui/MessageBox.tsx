...
const MessageCard: React.FC<MessageCardProps> = ({
  ...
  return (
    ...
    >
      {/* Profile Image */}
      <div className="relative h-8 w-8 min-w-[32px] overflow-hidden rounded-full bg-zinc-400">
        <Image
          src={imageUrl}
      ...
      {/* Message Wrapper */}
      <div className={`flex max-w-sm flex-col rounded-xl ${imagePosition === 'right' ? 'rounded-br-none' : 'rounded-bl-none'} ${messageBgColor} p-3`}>
